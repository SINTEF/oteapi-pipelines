...
try:
    dataMappings = [
        ...
        (
            "http://onto-ns.com/meta/oceanlab/2/ctd_data_munkholmen#pressure",
            "http://emmo.info/domain-mappings#mapsTo",
            "http://www.semanticweb.org/ocean_data/cf_standards/Oceanlab/0.0.1#sea_water_pressure",
        ),
        (
            "http://onto-ns.com/meta/oceanlab/2/ctd_data_munkholmen#conductivity",
            "http://emmo.info/domain-mappings#mapsTo",
            "http://www.semanticweb.org/ocean_data/cf_standards/Oceanlab/0.0.1#sea_water_electrical_conductivity",
        ),
        (
            "http://onto-ns.com/meta/oceanlab/2/ctd_data_munkholmen#density",
            "http://emmo.info/domain-mappings#mapsTo",
            "http://www.semanticweb.org/ocean_data/cf_standards/Oceanlab/0.0.1#sea_water_density",
        ),
        (
            "http://onto-ns.com/meta/oceanlab/2/ctd_data_munkholmen#time",
            "http://emmo.info/domain-mappings#mapsTo",
            "http://www.wikidata.org/entity/Q186885",
        ),
    ]
...
try:
    generate = client.create_function(
        ...
        configuration={
            ...
            "datamodel": "http://onto-ns.com/meta/oceanlab/2/ctd_data_munkholmen",
        },
    )
...
try:
    pipeline = parser >> mapping >> generate
