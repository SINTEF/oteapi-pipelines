...
try:
    dataMappings2 = [
        (
            "http://onto-ns.com/meta/1/castawayreturn_local#salinity",
            "http://emmo.info/domain-mappings#mapsTo",
            "http://www.semanticweb.org/ocean_data/cf_standards/Oceanlab/0.0.1#sea_water_practical_salinity",
        ),
        (
            "http://onto-ns.com/meta/1/castawayreturn_local#pressure",
            "http://emmo.info/domain-mappings#mapsTo",
            "http://www.semanticweb.org/ocean_data/cf_standards/Oceanlab/0.0.1#sea_water_pressure",
        ),
        (
            "http://onto-ns.com/meta/1/castawayreturn_local#temperature",
            "http://emmo.info/domain-mappings#mapsTo",
            "http://www.semanticweb.org/ocean_data/cf_standards/Oceanlab/0.0.1#temperature",
        ),
        (
            "http://onto-ns.com/meta/1/castawayreturn_local#depth",
            "http://emmo.info/domain-mappings#mapsTo",
            "http://www.semanticweb.org/ocean_data/cf_standards/Oceanlab/0.0.1#depth",
        ),
        (
            "http://onto-ns.com/meta/1/castawayreturn_local#time",
            "http://emmo.info/domain-mappings#mapsTo",
            "http://www.wikidata.org/entity/Q186885",
        ),
        (
            "http://onto-ns.com/meta/1/castawayreturn_local#samples_per_second",
            "http://emmo.info/domain-mappings#mapsTo",
            "http://www.semanticweb.org/ocean_data/cf_standards/Oceanlab/0.0.1#samples_per_second",
        ),
    ]
...
try:
    generate_netcdf = client.create_function(
        functionType="dlite-netcdf",
        configuration={
            "storage_paths": ["/entities"],  # local bound path in container
            "target_directory": "/output",
            "target_file": "oceanlab_demo.nc",
            "netcdf_entity": "http://onto-ns.com/meta/1/castawayreturn_local",
            "data_variables": [
                {"property": "pressure", "dimension_names": {"time"}},
                {"property": "temperature", "dimension_names": {"time"}},
                {"property": "salinity", "dimension_names": {"time"}},
                {"property": "depth", "dimension_names": {"time"}},
            ],
            "coordinates": [{"property": "time"}],
            "time_type": "start+frequency",
            "time_start": "time",
            "time_samples_per_unit": "samples_per_second",
            "time_frequency_unit": "s",
            "time_periods": "num_samples",
        },
    )
    print(generate_netcdf.strategy_id)
except Exception as e:
...
try:
    pipeline = parser >> input_mapping >> generator_mapping >> generate_netcdf
    ...
    if response.lower() == "y":
        ...
        # Print the XArray Dataset to the console.
        print(ds)
except Exception as e:
